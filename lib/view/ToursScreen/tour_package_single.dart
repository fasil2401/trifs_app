...
class TourPackageSingle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Obx(
          () => tourPackageController.isLoading.value
              ? Container(
                  height: 100.h,
                  width: 100.w,
                  child: Center(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: CachedNetworkImage(
                                        imageUrl:
                                            '${Api.imageUrl}${tourPackageController.tourPackage.value.image}',
                                        // height: 10.h,
                                        fit: BoxFit.cover,
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(
                                                                  height: 10),
                                                              AgencySingleTile(
                                                                agencyName: tourPackageController
                                                                        .agency
                                                                        .value
                                                                        .name ??
                                                                    '',
                                                                agencyAddress:
                                                                    tourPackageController
                                                                            ...
                                                                            .address ??
                                                                        '',
                                                                agencyImage: tourPackageController
                                                                        .agency
                                                                        .value
                                                                        .logo ??
                                                                    '',
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                    CachedNetworkImage(
                                                                  imageUrl:
                                                                      '${Api.imageUrl}${tourPackageController.imageList[index].image}',
                                                                  // height: 10.h,
                                                                  fit: BoxFit
                                                                      .cover,
                                                                  errorWidget: (context,
