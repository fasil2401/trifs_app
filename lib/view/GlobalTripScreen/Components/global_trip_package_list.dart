...
import 'package:trifs_app/view/GlobalTripScreen/global_trip_package_single.dart';
import 'package:trifs_app/view/Home%20Screen/recomended_package_single.dart';

List<int> list = [];

class GlobalTripPackageCardList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) => GestureDetector(
        onTap: () {
          Get.to(() => GlobalTripPackageSingle());
        },
        child: Container(
